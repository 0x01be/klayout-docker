...
RUN ./build.sh -release -ruby /usr/bin/ruby -python /usr/bin/python3 -qt5 -qmake /usr/bin/qt5-qmake -build /klayout/build -bin /opt/klayout/bin -with-qtbinding -with-64bit-coord
